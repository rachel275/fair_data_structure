...
do
  ...
  do
    for t in 10 30 60
    do
       echo "./list_main -t$t -i$i -f$f > ./data/default_list/ithreads${i}_fthreads${f}_duration${t}_sepCPU_CLOUBLAB"
       ./list_main -t$t -i$i -f$f > ./data/default_list/ithreads${i}_fthreads${f}_duration${t}_sepCPU_CLOUDLAB
       echo "./ns_c_list_main -t$t -i$i -f$f > ./data/ns_c_list/ithreads${i}_fthreads${f}_duration${t}_sepCPU_CLOUDLAB"
       ./ns_c_list_main -t$t -i$i -f$f > ./data/ns_c_list/ithreads${i}_fthreads${f}_duration${t}_sepCPU_CLOUDLAB  
    done
  done
done
