  ...
  do
    ...
    do
      ...
      do
        ...
        do
          m=1
          echo "./list_main -n$n -m$m -t$t -i$i -f$f -d$d > ./data/default_list/nthreads${n}_duration${t}_ratio${i},${f},${d}"
          ./list_main -n$n -m$m -t$t -i$i -f$f -d$d > ./data/default_list/nthreads${n}_duration${t}_ratio${i},${f},${d}
          echo "./ns_c_list_main -n$n -m$m -t$t -i$i -f$f -d$d > ./data/ns_c_list/nthreads${n}_duration${t}_ratio${i},${f},${d}"
          ./ns_c_list_main -n$n -m$m -t$t -i$i -f$f -d$d > ./data/ns_c_list/nthreads${n}_duration${t}_ratio${i},${f},${d}
        done
      done  
    done
  done
